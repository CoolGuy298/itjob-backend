...
const {
  ...
  upload,
  getCV,
  getFilterJobApplicationsByCompanyIdStatus,
...
router.get('/jobApplications/count', getJobApplicationCount);
...
router.post('/jobApplications/company/:companyId/status', authMiddleware, getFilterJobApplicationsByCompanyIdStatus);
